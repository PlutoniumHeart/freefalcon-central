...
int FalconSessionEntity::Save(VU_BYTE** stream)
{
    ...
    *stream += sizeof(VU_ID);
    memcpy(*stream, &playerFlight, sizeof(VU_ID));
    *stream += sizeof(VU_ID);
    memcpy(*stream, &playerEntity, sizeof(VU_ID));
    *stream += sizeof(VU_ID);
    memcpy(*stream, &AceFactor, sizeof(float));
    *stream += sizeof(float);
    memcpy(*stream, &initAceFactor, sizeof(float));
    *stream += sizeof(float);
    memcpy(*stream, &bubbleRatio, sizeof(float));
    *stream += sizeof(float);
    memcpy(*stream, &country, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &aircraftNum, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &pilotSlot, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &flyState, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &reqCompression, sizeof(short));
    *stream += sizeof(short);
    memcpy(*stream, kills, sizeof(kills));
    *stream += sizeof(kills);
    memcpy(*stream, &rating, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &voiceID, sizeof(uchar));
    *stream += sizeof(uchar);
    memcpy(*stream, &missions, sizeof(ushort));
